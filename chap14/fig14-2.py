...
fit = cmdstanpy.from_csv('output/result-model14-1')
...
p.save(filename='output/fig14-2-left.py.png', dpi=300, width=6, height=5)
...
p.save(filename='output/fig14-2-right.py.png', dpi=300, width=6, height=5)
