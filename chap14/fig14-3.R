...
fit <- readRDS('output/result-model14-2.RDS')
...
d_obs <- data.frame(T=c(0, d_survfit$time), surv=c(1, d_survfit$surv), n.censor=c(0, d_survfit$n_censor))
...
ggsave(p, file='output/fig14-3-left.png', dpi=300, width=6, height=5)
...
ggsave(p, file='output/fig14-3-right.png', dpi=300, width=6, height=5)
