...
fit = cmdstanpy.from_csv('output/result-model11-13-wo-AR')
...
p.save(filename='output/fig11-20-left.py.png', dpi=300, width=4, height=3)

fig = plt.figure(figsize=(6, 4))
ax1 = fig.add_subplot(111)
sm.graphics.tsa.plot_acf(d_est['50%'], lags=32, ax=ax1, missing='drop')
plt.savefig('output/fig11-20-right.py.png', dpi=300)
