...
T = len(d)
Tp = 3
fit = cmdstanpy.from_csv('output/result-model11-3')
...
p.save(filename='output/fig11-5-left.py.png', dpi=300, width=3.5, height=3)

d_residual = pandas.DataFrame({'50%':d_est['50%'][0:T] - d.Y})
fig = plt.figure(figsize=(6, 4))
ax1 = fig.add_subplot(111)
sm.graphics.tsa.plot_acf(d_residual['50%'], lags=13, ax=ax1)
plt.savefig('output/fig11-5-right.py.png', dpi=300)
