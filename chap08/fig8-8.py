...
d_wide = pandas.read_csv('input/data-conc-2.csv')
N = len(d_wide)
...
fit = cmdstanpy.from_csv('output/result-model8-6')
...
p.save(filename='output/fig8-8.py.png', dpi=300, width=8, height=7)
